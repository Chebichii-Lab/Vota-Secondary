...
urlpatterns = [
    ...
    path('exam1/', StaffViews.exam1, name='exam1'),
    path('exam1/', StaffViews.exam2, name='exam2'),
    path('exam1/', StaffViews.endterm, name='endterm'),
    path('exam1/', StaffViews.finalreport, name='finalreport'),
