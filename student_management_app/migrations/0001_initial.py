# Generated by Django 3.0.7 on 2021-09-23 21:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('class_name', models.CharField(choices=[('form-one', 'form-one'), ('form-two', 'form-two'), ('form-three', 'form-three'), ('form-four', 'form-four')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Courses',
